...
class _MatchScreenState extends State<MatchScreen>
  ...
  // ✅ Campo mutable local — widget.teamData es final y no se puede mutar
  ...
  void initState() {
    super.initState();
    _teamData = widget.teamData; // ✅ copia mutable inicial
  ...
  void _continueToNextMatch() {
    if (_calculateTeamAScore() >= targetScore) teamAWins++;
    else if (_calculateTeamBScore() >= targetScore) teamBWins++;
              ...
              children: [
                ...
                Container(
                  padding: const EdgeInsets.only(
                      left: 16, right: 16, top: 40, bottom: 8),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // ✅ Botón que abre el modal con _teamData mutable
                      IconButton(
                            ...
                            children: [
                              Text('SALIDA',
                                  style: TextStyle(
                                      ...
                                      color: slate400,
                                      letterSpacing: 1)),
                              // ✅ _teamData en lugar de widget.teamData
                              Text(_teamData.startingPlayerName,
                                  style: const TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.bold,
                                      color: charcoalColor)),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(_calculateTeamAScore().toString(),
                                  style: const TextStyle(
                                      fontSize: 32,
                                      fontWeight: FontWeight.w900,
                                      color: charcoalColor)),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(_calculateTeamBScore().toString(),
                                  style: const TextStyle(
                                      fontSize: 32,
                                      fontWeight: FontWeight.w900,
                                      color: charcoalColor)),
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final teamAScoreValue =
                          round['teamAScore'] as int;
                      final teamBScoreValue =
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Continuar a la siguiente partida',
                        style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold)),
                  ),
      ...
      bottomSheet: _hideButtons
          ...
          : Container(
              decoration: BoxDecoration(
                ...
                border:
                    Border(top: BorderSide(color: slate100, width: 1)),
              ),
              padding: const EdgeInsets.all(12),
              child: Column(
                mainAxisSize: MainAxisSize.min,
